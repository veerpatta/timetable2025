(function initI18n(root, factory) {
	...
	const dictionaries = {
		en: {
			...
			'sub.last_resort': 'Duty-holder · only if no one else is free',
			'sub.reserve': 'Admin staff',
			'sub.noCandidates': 'No available teacher found.',
			'sub.selfStudyWhy': 'No teacher free · the class sits self study',
			'sub.combineOffer': 'Combine with {class} · {teacher}?',
			'sub.joins': '→ {class} · {teacher}',
			'sub.combinedWhy': 'Class joins {class} with {teacher}',
			'sub.combineLost': 'The class it was joining no longer has a teacher',
			...
			'edit.combine': 'Send them to {class}',
			'edit.combineWhy': 'One teacher takes both classes · {teacher}',
			'edit.reserve': 'Admin staff — ask before assigning',
			'edit.reserveWhy': 'Never chosen automatically',
			...
			'warning.reserve_staff': 'Admin staff · assign only if you have asked',
			'warning.duty_holder': 'Coordinator / exam duty · free only if no one else is',
		...
		hi: {
			...
			'sub.last_resort': 'प्रभार धारक · कोई और खाली न हो तभी',
			'sub.reserve': 'प्रशासनिक स्टाफ',
			'sub.noCandidates': 'कोई उपलब्ध शिक्षक नहीं मिला।',
			'sub.selfStudyWhy': 'कोई शिक्षक खाली नहीं · कक्षा स्वयं अध्ययन करेगी',
			'sub.combineOffer': '{class} · {teacher} के साथ मिलाएँ?',
			'sub.joins': '→ {class} · {teacher}',
			'sub.combinedWhy': 'कक्षा {class} में {teacher} के साथ जाएगी',
			'sub.combineLost': 'जिस कक्षा में मिलाया था, वहाँ अब शिक्षक नहीं है',
			...
			'edit.combine': '{class} में भेजें',
			'edit.combineWhy': 'एक शिक्षक दोनों कक्षाएँ संभालेंगे · {teacher}',
			'edit.reserve': 'प्रशासनिक स्टाफ — नियुक्ति से पहले पूछें',
			'edit.reserveWhy': 'स्वतः कभी नहीं चुने जाते',
			...
			'warning.reserve_staff': 'प्रशासनिक स्टाफ · पूछकर ही नियुक्त करें',
			'warning.duty_holder': 'समन्वयक / परीक्षा प्रभार · अन्य कोई खाली न हो तभी',
